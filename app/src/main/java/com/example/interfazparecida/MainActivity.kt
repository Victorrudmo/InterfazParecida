package com.example.interfazparecida
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var btnShutdown: ImageButton
    ...
    private fun initEvent() {
        ...
        btnSettings = findViewById(R.id.btn_ajustes)
        btnSettings.setOnClickListener {
            openSettings()
        }

        btnShutdown = findViewById(R.id.btn_apagar)
